...
use iced::advanced::{layout, mouse, renderer, text, widget, Clipboard, Layout, Shell, Widget};
use iced::keyboard::key;
use iced::overlay::menu;
use iced::widget::{text_input, TextInput};
use iced::{
    event, keyboard, overlay, Element, Event, Length, Padding, Rectangle, Size, Theme, Vector,
};
...
where
    ...
    Theme: iced::widget::combo_box::Catalog + 'a + components::combo_box::Catalog,
...
where
    Theme: iced::widget::combo_box::Catalog,
    Renderer: text::Renderer,
{
    state: &'a State<T>,
...
where
    T: std::fmt::Display + Clone,
    Theme: iced::widget::combo_box::Catalog + components::combo_box::Catalog,
    Renderer: text::Renderer,
{
    ...
    pub fn new(
        ...
        let text_input = TextInput::new(placeholder, &state.value())
            ...
            .class(<Theme as components::combo_box::Catalog>::default_input());
        ...
        Self {
            ...
            on_open: None,
            on_close: None,
            menu_class: <Theme as iced::widget::combo_box::Catalog>::default_menu(),
    ...
    T: Display + Clone,
{
    ...
    pub fn change_options(&mut self, options: Vec<T>) {
        self.options = options;

        let option_matchers = build_matchers(&self.options);
        self.with_inner_mut(|inner| {
            inner.option_matchers = option_matchers;
            inner.filtered_options.update(
...
where
    T: Display + Clone + 'static,
    Message: Clone + 'a,
    Theme: iced::widget::combo_box::Catalog + 'a,
